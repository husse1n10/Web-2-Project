...
<div class="page">
    ...
    <div class="footer">
        <div class="left">
            This is an official receipt generated by the CedarGov Platform.<br>
            For inquiries, contact: {{ $serviceRequest->office->email ?? 'support@cedargov.local' }}<br>
            &copy; {{ date('Y') }} CedarGov - All rights reserved.
        </div>
        <div class="right">
